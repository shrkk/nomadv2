...
Plans:
- [ ] 02-01-PLAN.md — AuthManager, UserService, data models, Firestore schema, security rules
- [ ] 02-02-PLAN.md — Full onboarding flow (7 screens: Welcome through Home City Confirm)
- [ ] 02-03-PLAN.md — Location pipeline (background GPS, CLVisit monitor, RDP simplification)
- [ ] 02-04-PLAN.md — Place categorization service + trip finalization pipeline
